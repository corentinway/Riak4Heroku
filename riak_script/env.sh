...
RUNNER_SCRIPT_DIR=/app/.dpkg/usr/sbin
RUNNER_SCRIPT=${0##*/}

RUNNER_BASE_DIR=/app/.dpkg/usr/lib/riak
RUNNER_ETC_DIR=/app/.dpkg/etc/riak
RUNNER_LOG_DIR=/app/.dpkg/var/log/riak
...
RUN_DIR="/app/.dpkg/var/run" # for now hard coded unless we find a platform that differs
